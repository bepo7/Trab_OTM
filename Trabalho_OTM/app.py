...
def safe_num(val):
    """Converte NaN/Inf para None (null no JSON) para não quebrar o site"""
    if val is None: return None
    try:
        # Verifica se é um número antes de checar nan/inf
...
def formatar_dados_para_frontend(ticker_list, peso_array, valor_investido):
    alocacao = []
    # Garante que não tem NaN no array de pesos
...
def processar_otimizacao():
    ...
    try:
        ...
        # 5. Dados Interativos (Chart.js) - COM LIMPEZA
